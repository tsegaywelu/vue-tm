      ...
      >
        ...
        >
          ...
          <div class="flex gap-2">
            ...
            <!-- Print button hidden until print layout is finalized -->
...
const approveMutation = useMutation({
  ...
  onError: (error: any) => {
    toast.error(
      error.response?.data?.description || "Failed to approve invoice",
    );
  },
});
...
const handleApprove = () => {
  approveMutation.mutate({
    paymentApprovedBy: auth.current_user?.user?._id,
  });
};
