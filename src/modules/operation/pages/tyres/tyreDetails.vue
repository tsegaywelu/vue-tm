<template>
  <div class="h-full flex flex-col gap-4">
    ...
    <!-- Tabs List -->
    <!-- <div
      class="rounded-[20px] bg-surface px-3 md:px-5 py-2.5 flex items-center gap-3 overflow-x-auto no-scrollbar whitespace-nowrap shadow-sm border border-gray-100"
    >
      <Button
        v-for="tab in tabs"
        :key="tab.key"
