...
const handleCreateShipment = async (values: any, context: any) => {
  ...
  const payload: any = {
    ...
    dispatchWeight: Number(values.dispatchWeight) || "",
    odometerAtDispatch: Number(values.odometerAtDispatch) || "",
    fuelReadingAtDispatch: Number(values.fuelReadingAtDispatch) || "",
    deadHole: Math.max(0, Number(values.deadHole)) || "",
    ...
    pricingType: {
      ...
      amount: filteredPricingType?.pricePerUnit || "",
    },
  };
