...
function newEmptyItem(): OrderItem {
  return {
...
// Watch for external changes to form field (e.g. from handlePRSelect)
watch(
...
<template>
  <InputParent
    :validation="{
      allValuesExist(values: OrderItem[]) {
  ...
  >
    <div class="mt-8">
      <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-900">Ordered Items</h3>
      </div>
