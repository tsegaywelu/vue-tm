  ...
  <div class="flex flex-col gap-3">
    ...
    <div class="relative">
      <input
        ...
        class="w-full text-xs border border-gray-200 rounded-lg px-2.5 py-1.5 pl-7 focus:outline-none focus:ring-2 focus:ring-primary-300"
      />
      ...
      <div v-if="col.type === 'date'" class="grid grid-cols-2 gap-2">
        ...
        <div class="flex flex-col gap-1">
          ...
          <select
            ...
            class="text-sm border border-gray-200 rounded-lg px-2 py-1.5 bg-white focus:outline-none focus:ring-2 focus:ring-primary-300 disabled:opacity-40 disabled:cursor-not-allowed"
