<template>
  <div class="flex flex-wrap items-end gap-4 bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
    ...
    <div class="flex gap-4 min-w-[400px]">
      <div class="flex-1">
        <label class="block text-xs font-bold text-gray-400 uppercase mb-2 ml-1">Origin</label>
        <SelectInput
      ...
      <div class="flex-1">
        <label class="block text-xs font-bold text-gray-400 uppercase mb-2 ml-1">Destination</label>
        <SelectInput
    ...
    <div class="relative min-w-[200px]">
      <label class="block text-xs font-bold text-gray-400 uppercase mb-2 ml-1">Date Range</label>
      <button
        type="button"
