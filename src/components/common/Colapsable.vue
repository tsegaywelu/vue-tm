<template>
  ...
  >
    ...
    >
      ...
      <button
        type="button"
        class="size-10 min-w-10 shrink-0 rounded-full flex items-center justify-center bg-surface border border-line shadow-sm group-hover:border-primary/30 group-hover:text-primary transition-all duration-300"
      >
        <div
