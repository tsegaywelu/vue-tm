  ...
  >
    ...
    >
      ...
      >
        <button
          @click="zoomIn"
          class="px-3 py-1.5 bg-white border border-gray-200 hover:bg-gray-50 rounded-lg text-sm font-medium transition-colors text-gray-700 shadow-sm flex items-center gap-1.5"
        >
      ...
      <!-- Viewer Content -->
      <div
        class="flex-1 overflow-hidden bg-gray-100 flex justify-center items-center p-4"
      >
        <!-- PDF -->
        <div
          v-if="isPDF"
          class="w-full h-full flex justify-center items-center overflow-auto rounded-xl"
        >
          <iframe
        ...
        <div
          v-else-if="isImage"
          class="w-full h-full flex justify-center items-center overflow-auto relative"
        >
          <img
            :src="fileURL"
